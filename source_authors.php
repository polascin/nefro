...
function getSourceArticleAuthors(): array {
    return [
        ...
        'kedy-zacat-krt-pri-aki' => ['Ostermann M', 'Bagshaw SM', 'Lumlertgul N', 'Wald R'],
        ...
        'umela-inteligencia-nefrologia-co-vieme-limity' => ['Singh P', 'Goyal L', 'Mallick DC', 'Surani SR', 'Kaushik N', 'Chandramohan D', 'Simhadri PK'],
    ];
}
