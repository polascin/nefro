...
function getSourceArticleAuthors(): array {
    return [
        ...
        'transverzalna-koaxialna-biopsia-nativnej-oblicky-vytaznost' => ['Lei Huang', 'Xiaolin Zhan', 'Lin Chen', 'Jing Zhang', 'Nanyan Luo', 'Yangyang Wang', 'Dongmei Wang', 'Jie Liu', 'Lili Ren', 'Mian Li', 'Qi Yang', 'Haiyu Luo'],
