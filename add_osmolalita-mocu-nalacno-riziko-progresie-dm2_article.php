...
<div class="table-responsive" role="region" aria-label="Výsledky: rovnaký smer, nie úplná replikácia" tabindex="0">
<table>
  <thead>
    <tr>
...
<ul>
  <li class="pdf-avoid-break"><strong>Observačný dizajn:</strong> štúdia preukazuje asociáciu, nie kauzalitu. Nemožno vylúčiť reziduálne a nemerané skresľujúce faktory ani obrátenú kauzalitu.</li>
  <li class="pdf-avoid-break"><strong>Jedno východiskové meranie:</strong> výsledok môže ovplyvniť hydratácia, strava, glykozúria, lieky a bežná vnútroindividuálna variabilita. Nie je známe, akú prognostickú hodnotu má priemer opakovaných meraní.</li>
  <li class="pdf-avoid-break"><strong>Čiastočná replikácia:</strong> rovnaký smer odhadov je povzbudivý, ale každý z dvoch výsledkov bol štatisticky významný iba v jednej kohorte.</li>
  <li class="pdf-avoid-break"><strong>Relatívne kategórie:</strong> tercily rozdeľujú konkrétnu kohortu a nevytvárajú všeobecne použiteľnú hranicu pre jednotlivého pacienta.</li>
  <li class="pdf-avoid-break"><strong>Nešpecifickosť:</strong> osmolalita nedokáže sama odlíšiť tubulointersticiálne poškodenie od vplyvu zníženej filtrácie, vazopresínu, osmotického príjmu, glykozúrie alebo liečby.</li>
  <li class="pdf-avoid-break"><strong>Súčasná terapia:</strong> vzťah treba znova overiť v populáciách liečených dnešnou kombinovanou kardiorenálnou liečbou, najmä inhibítormi SGLT2.</li>
  <li class="pdf-avoid-break"><strong>Klinická využiteľnosť:</strong> uvedené pomery rizík a šancí samy osebe nedokazujú zlepšenie diskriminácie, kalibrácie alebo reklasifikácie rizika a neoverujú liečbu riadenú osmolalitou.</li>
</ul>
