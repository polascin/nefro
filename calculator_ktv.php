            ...
            <div class="auth-container auth-container--wide">
                ...
                <form method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group"><label>Meno</label><input type="text" name="patient_first_name" class="form-control" value="<?= htmlspecialchars($form['patient_first_name']) ?>"></div>
                            <div class="form-group"><label>Priezvisko</label><input type="text" name="patient_last_name" class="form-control" value="<?= htmlspecialchars($form['patient_last_name']) ?>"></div>
                            <div class="form-group"><label>Dátum nar.</label><input type="date" name="patient_birth_date" class="form-control" value="<?= htmlspecialchars($form['patient_birth_date']) ?>"></div>
                            <div class="form-group"><label>Rodné číslo</label><input type="text" name="patient_birth_number" class="form-control" value="<?= htmlspecialchars($form['patient_birth_number']) ?>"></div>
                        </div>
                    </div>
