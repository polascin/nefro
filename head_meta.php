...
<meta name="referrer" content="<?= htmlspecialchars(function_exists('getRequestReferrerPolicy') ? getRequestReferrerPolicy() : 'strict-origin-when-cross-origin', ENT_QUOTES, 'UTF-8') ?>">
