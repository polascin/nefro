...
$articles[] = [
    ...
    'is_top'       => 0,
    'excerpt'      => 'Podocalyxín v moči odlíšil diabetikov s albuminúriou od tých bez nej s plochou pod krivkou 0,96. Plocha pod krivkou však pochádza z porovnania 59 diabetikov (30 s albuminúriou verzus 29 bez nej), nie z celého súboru 88 osôb, je len vnútorne validovaná a samotné ochorenie bolo definované práve tým, čo mal marker predpovedať.',
    'content'      => <<<'HTML'
...
<ol>
  ...
  <li><strong>Prediktívne hodnoty závisia od prevalencie.</strong> Pozitívna prediktívna hodnota 100 % vyplýva z toho, že v súbore nebol ani jeden falošne pozitívny výsledok (špecificita 29/29). Pri <em>bodovej</em> špecificite presne 100 % by nižšia prevalencia sama osebe PPV nezmenila — bez falošne pozitívnych je PPV 100 % pri akejkoľvek prevalencii. Rozhodujúca je <strong>neistota</strong> tohto odhadu: 29 z 29 zodpovedá 95 % intervalu spoľahlivosti približne 88 – 100 % (Clopper-Pearson). Len čo je skutočná špecificita čo i len o niekoľko percent nižšia, PPV pri zriedkavejšej albuminúrii klesá podstatne. Preto sú potrebné externá validácia a odhad špecificity s intervalom, nie bodová hodnota.</li>
