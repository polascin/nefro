...
$urls = [
    ...
    [
        'loc'        => $baseUrl . 'calculator_mgrs.php',
        'lastmod'    => _sitemapLastmod('calculator_mgrs.php'),
        'changefreq' => 'monthly',
        'priority'   => '0.8',
    ],
    [
    ...
    [
        'loc'        => $baseUrl . 'calculator_ckm.php',
        'lastmod'    => _sitemapLastmod('calculator_ckm.php'),
        'changefreq' => 'monthly',
        'priority'   => '0.8',
    ],
    [
    ...
    [
        'loc'        => $baseUrl . 'lieky.php',
        'lastmod'    => _sitemapLastmod('lieky.php'),
        'changefreq' => 'weekly',
        'priority'   => '0.7',
    ],
    [
